...
tcp_pinned_track_gap : Track panel color between pinned and unpinned tracks -- current RGB: 0,0,0
tcp_pinned_track_gap_unreachable : Track panel color between pinned and unpinned tracks when some tracks are unreachable -- current RGB: 0,0,0
tcp_pinned_track_gap_mode : Track panel fill mode between pinned and unpinned tracks -- blendmode 00000000
pinned_track_gap : Arrange view color between pinned and unpinned tracks -- current RGB: 0,0,0
pinned_track_gap_mode : Arrange view fill mode between pinned and unpinned tracks -- blendmode 00000000
...
lpffadecol : Media item LPF fade color -- current RGB: 0,0,0
lpffademode : Media item LPF fade fill mode -- blendmode 00000000
col_mi_left : Media item left edge overlay -- current RGB: 0,0,0
col_mi_leftb : Media item left edge overlay blend mode -- blendmode 00000000
col_mi_leftsel : Media item left edge overlay (selected) -- current RGB: 0,0,0
col_mi_leftselb : Media item left edge overlay blend mode (selected) -- blendmode 00000000
...
Measures the drawing dimensions of a character (for example, ascii code point 97 is 'a') with the current font (as set by gfx_setfont).
